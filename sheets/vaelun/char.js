...
window.CHAR = {
  ...
  proficienciesNote:'Armadura média limita o bônus de Destreza a +2; brunea e meia armadura dão desvantagem em Furtividade. Sem proficiência na armadura vestida, não se conjura magias.',
  armorDefault:'leather',
  coins:{gp:'15'},
  items:'Kit de disfarce, ferramentas de falsário, rapieira, componentes arcanos, mochila, corda (15m), roupas comuns.',
